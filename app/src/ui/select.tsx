...
const selectTv = tv({
  slots: {
    ...
    input:
      'mt-0 flex-row font-jakarta text-base items-center justify-center border-[0.5px] bg-neutral-100 border-neutral-300 dark:border-neutral-700 dark:bg-neutral-800 px-4 py-4 rounded-xl dark:bg-neutral-800 dark:border-neutral-500',
