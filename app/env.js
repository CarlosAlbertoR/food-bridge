...
const BUNDLE_ID = 'com.github.iamsahebgiri.foodbridge'; // ios bundle id
const PACKAGE = 'com.github.iamsahebgiri.foodbridge'; // android package name
const NAME = 'foodbridge'; // app name
const EXPO_ACCOUNT_OWNER = 'expo-owner'; // expo account owner
const EAS_PROJECT_ID = 'c3e1075b-6fe7-4686-aa49-35b46a229044'; // eas project id
const SCHEME = 'foodbridge'; // app scheme
